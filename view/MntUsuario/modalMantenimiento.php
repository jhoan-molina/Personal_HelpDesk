            ...
            <form method="post" id="usuario_form">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="usu_correo" name="usu_correo" placeholder="example@correo.com" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="select2 select2-arrow manual select2-no-search-arrow" id="rol_id" name="rol_id">
                            <option>------</option>
